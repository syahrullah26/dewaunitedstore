    ...
    <div class="max-w-4xl mx-auto">
      ...
      >
        ...
        >
          ...
          <!-- goalkeeper - di atas/depan gawang (terpisah) -->
          <div
            class="absolute top-6 text-6xl md:text-7xl transition-all duration-300 ease-out drop-shadow-2xl z-10"
      ...
      >
        <div v-if="gameResult" class="text-center">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            <div
              class="bg-gradient-to-br from-purple-600 to-indigo-600 text-white rounded-xl p-6 md:p-8"
            >
              <span class="block text-5xl mb-3">⭐</span>
              <h2 class="text-4xl md:text-5xl font-bold mb-2">
                {{ gameResult.session.points_earned }}
              </h2>
            ...
            <div class="bg-gray-50 rounded-xl p-6 md:p-8">
              ...
              <h3 class="text-3xl md:text-4xl font-bold mb-2 text-gray-800">
                {{ gameResult.session.goals_scored }} /
                {{ gameResult.session.total_shots }}
              </h3>
          ...
          <div class="bg-gray-50 rounded-xl p-8 mb-8">
            <h3 class="text-xl font-bold mb-6 text-gray-800">
              Total Statistik Anda
            </h3>
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div>
                <span class="block text-sm text-gray-500 mb-1">Total Poin</span>
                <span class="block text-2xl font-bold text-purple-600">{{
                  gameResult.stats.total_points
                }}</span>
              </div>
              <div>
