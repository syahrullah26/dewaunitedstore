...
<template>
  <div class="min-h-screen bg-gradient-to-br from-[var(--gold-main)] via-[var(--gold-light)] to-[var(--gold-dark)] p-5">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Stats Cards Loading -->
      <div v-if="isLoadingStats" class="bg-white rounded-3xl p-16 shadow-2xl text-center mb-8">
      ...
      <div v-else-if="stats" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-gradient-to-br from-purple-600 to-indigo-600 text-white rounded-2xl p-6 shadow-xl md:col-span-2 flex items-center gap-5">
          ...
          <div class="flex-1">
            <h2 class="text-4xl md:text-5xl font-bold mb-1">{{ stats.total_points }}</h2>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          ...
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.rank || '-' }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">🎮</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.games_played }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">⚽</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.total_goals }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">💯</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.best_score }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">🎯</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.accuracy }}%</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">🔥</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.current_streak }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl flex items-center gap-4">
          <div class="text-4xl">🌟</div>
          <div class="flex-1">
            <h3 class="text-3xl font-bold text-gray-800 mb-1">{{ stats.best_streak }}</h3>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-xl md:col-span-2">
          <div class="grid grid-cols-2 gap-6">
            <div class="text-center">
              <span class="block text-sm text-gray-600 mb-2">Rata-rata Poin/Game</span>
              <span class="block text-3xl font-bold text-purple-600">{{ avgPointsPerGame }}</span>
            </div>
            <div class="text-center">
              <span class="block text-sm text-gray-600 mb-2">Rata-rata Gol/Game</span>
              <span class="block text-3xl font-bold text-purple-600">{{ avgGoalsPerGame }}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div v-else-if="history.length > 0" class="space-y-4">
          ...
          >
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
              <span class="text-sm text-gray-600">{{ formatDate(game.ended_at) }}</span>
              <span class="text-xl font-bold text-purple-600">+{{ game.points_earned }} poin</span>
            </div>
